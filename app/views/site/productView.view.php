        ...
        <div class="main">
            <div class="card">
                ...
                <div class="productPic">
                    <h2 class="title">La Photelier</h2>
                    <div class="displayPic">
                        <div class="showPic">
                            <img src="https://images.unsplash.com/photo-1453728013993-6d66e9c9123a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8Zm9jdXN8ZW58MHx8MHx8&w=1000&q=80" alt="foto tirada por Fulano">
                            <img src="../../../public/assets/frame-product1.jpg" alt="produto em uma moldura para visualizacao">
                            <img src="../../../public/assets/frame-product2.jpg" alt="produto em uma moldura para visualizacao">
                        </div>
                    </div>
                    <div class="selectPic">
                        <div class="itemPic">
                ...
                <div class="productContent">
                    ...
                    <a href="#" class="artistLink">Obras de Fulano</a>
                    ...
                    <div class="productPrice">
                        <p class="lastPrice">Preço anterior: <span>R$257,00</span></p>
                        <p class="newPrice">Preço atual: <span>R$139,90</span></p>
                    </div>
                    ...
                    <div class="productDetail">
                        ...
                        <ul>
                            <li>Categoria: <span>Fotografia</span></li>
