...
<body>
  ...
  <div class="logo_contato">
      <img src="https://trello.com/1/cards/6245b4963426e13d81f187c3/attachments/624711352026307dadbed2e3/download/LogoArtella.png" 
        alt="Artella logo">
  </div>
  ...
  <div class="formulario">
      <div class="form-floating mb-3 form nome">
        ...
        <div class="form-floating mb-3 form email">
          <input type="form-control" class="form-control" id="floatingPassword" placeholder="Password">
