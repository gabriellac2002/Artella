<button class="btn btnView" data-bs-toggle="modal" data-bs-target="#viewAction">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header my-3">
                <h5 class="modal-title" style="text-transform: uppercase;">Visualização da categoria <?php echo $categoria['name']; ?></h5>
                <!-- Botão fechar -->
